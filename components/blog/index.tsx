...
if(product.length<=0) return null;
  return (
    ...
    <div className="item-center h-full w-full  p-6 px-6 mx-auto  max-w-screen-2xl">
      <div className=" max-h-88rem       p-4 text-white ">
        <div className="flex flex-col gap-8 md:flex-row">
          ...
          alt={product[0]?.featuredImage.altText}
            ...
            <p className="mt-2 text-gray-600 text-base">{product[0]?.description}</p> <button className="marker:  mt-2  rounded bg-white px-8 py-3 font-serif text-black transition-colors">
              READ MORE
            </button>
          </div>
          ...
          <div className="font-serif bg-gray-100 p-6 md:w-1/2">
            ...
            <p className="mt-2 text-gray-600 text-base">{product[1]?.description}</p>
