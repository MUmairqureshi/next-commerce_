    ...
    <>
      ...
      <Transition show={isOpen}>
        <Dialog onClose={closeCart} className="relative z-50">
          ...
          >
            <Dialog.Panel className="fixed bottom-0 right-0 top-0 flex h-full w-full flex-col border-l border-neutral-200 bg-[#003445] p-6 text-white backdrop-blur-xl dark:border-neutral-700 dark:bg-black/80 dark:text-white md:w-[390px]">
              ...
              {!cart || cart.lines.length === 0 ? (
                ...
                <div className="flex h-full flex-col justify-between overflow-hidden p-1">
                  ...
                  <a
                    ...
                    className="block w-full rounded-sm bg-gray-900 p-3 text-center text-sm font-medium text-white opacity-90 hover:opacity-100"
                  >
                    CHECKOUT
                  </a>
                </div>
